...
namespace Tiandao.Serialization
{
    public class Serializer : ISerializer, ITextSerializer
	{
		...
		private static ITextSerializer _text = new Serializer(new TextSerializationWriter(), TextSerializationSettings.Default);
		private static ITextSerializer _json = new Serializer(new JsonSerializationWriter(), TextSerializationSettings.Default);
